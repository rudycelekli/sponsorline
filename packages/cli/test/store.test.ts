...
describe("Store", () => {
  it("round-trips consent, inventory, ledger, and witness entries", () => {
    ...
    s.appendWitness({ payload: { v: 1, ts: 1, consentId: "c_x", prevHash: "", signals: ["lang:ts"], seed: "1", reserveCents: 100, winnerId: "a", winningCreative: "A", clearingPriceCents: 100, bidders: [{ id: "a", bidCents: 100, targetSignals: ["lang:ts"], creative: "A" }] }, sig: "cd" });
    s.appendWitness({ payload: { v: 1, ts: 2, consentId: "c_x", prevHash: "", signals: ["lang:ts"], seed: "2", reserveCents: 100, winnerId: "a", winningCreative: "A", clearingPriceCents: 100, bidders: [{ id: "a", bidCents: 100, targetSignals: ["lang:ts"], creative: "A" }] }, sig: "ef" });
